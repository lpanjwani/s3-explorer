...
export * as S3ControllerClient from './index/S3ControllerClient';

export * as S3ControllerQuery from './index/S3ControllerQuery';

import { addResultTypeFactory } from './index/helpers';
export { setBaseUrl, getBaseUrl } from './index/helpers';
export { setAxiosFactory, getAxios } from './index/helpers';

//-----PersistorHydrator.File-----
import type { PersistedClient } from '@tanstack/react-query-persist-client';
import type { DehydratedState, QueryKey } from '@tanstack/react-query';
import { getResultTypeFactory } from './index/helpers';
...
export function initPersister() {
	addResultTypeFactory('S3ControllerClient___listBuckets', (data: any) =>
		Types.initListBucketDto(data)
	);
	addResultTypeFactory('S3ControllerClient___listObjects', (data: any) =>
		Types.initListObjectDto(data)
	);
}
//-----/PersistorHydrator.File----
